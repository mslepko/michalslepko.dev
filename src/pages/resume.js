    ...
    <section className="flex items-center justify-between px-8 mb-20 tracking-wider">
      <div className="flex flex-col w-full md:w-1/3 space-y-12 text-center md:text-left">
        <div className="flex flex-col px-10 md:px-20">
          <h3 className="text-xl font-bold" id="skills">
            Skills
          </h3>
          <br />
          <span className="text-lg text-darkest dark:text-lightest">
          ...
          <span className="text-lg text-darkest dark:text-lightest">
            JavaScript + a bit of TypeScript
          </span>
          <span className="text-lg text-darkest dark:text-lightest">
          ...
          <span className="text-lg text-darkest dark:text-lightest">
            PERL, MySQL, Bash, GIT, Linux, SASS, jQuery
          </span>
          <span className="text-lg text-darkest dark:text-lightest">
        ...
        <div className="px-10 md:px-20">
          <h3 className="text-xl font-bold" id="contact">
            Summary
          </h3>
          <br />
          <p className="w-full md:w-2/3">
            I'm a full-stack web developers with many years of experience
            working with different teams and technologies. Through years I had
            to wear many different hats - from frontend developer to Linux
            server sysadmin.
          </p>
          <p className="mt-2 w-full md:w-2/3">
            I've been working remotely for more than 6 years and I know the
            power of good communication.
          </p>
          <p className="mt-2 w-full md:w-2/3">
            I'm not afraid of working on the legacy code, I still maintain an
            old platform written in PHP5. So if you want to free up your
            development team from legacy burden I'm the person you want to hire.
          </p>
        </div>
        <div className="px-10 md:px-20">
          <br />
          ...
          <p>
            <a
              className="text-xl hover:text-blue-600 line-break-anywhere"
          ...
          <p>
            <a
              ...
              href="https://cal.com/michalslepko/coffee-chat-with-michal"
              target="_blank"
          ...
          <p>
            <a
              className="text-xl hover:text-blue-600"
              href="https://drive.google.com/file/d/1e8O9QjakgEkUmpQDnEHCVuda2u0kQ7gZ/view?usp=sharing"
              target="_blank"
              rel="noopener noreferrer"
            >
              My CV in PDF
        ...
        <div className="px-10 md:px-20">
          <ul className="flex flex-row items-end gap-2 md:items-center md:space-x-4 space-y-4 md:space-y-0 justify-between">
            <li>
              <a
                href="https://www.instagram.com/michal.codes/"
                target="_blank"
                aria-label="Instagram"
                className="hover:text-blue-600 socials"
                rel="noopener noreferrer"
              >
                <Instagram />
              </a>
            ...
            <li>
              <a
                href="https://www.github.com/mslepko"
                target="_blank"
                aria-label="Github"
                className="hover:text-blue-600 socials"
                rel="noopener noreferrer"
      ...
      <div className="hidden md:flex flex-col w-1/3 space-y-12 text-right">
        <div className="px-20">
          <h4 className="text-xl font-bold">
            Full-stack developer (mainly PHP, JS)
          </h4>
          <br />
        ...
        <div className="px-20">
          <h4 className="text-xl font-bold">
            Technical lead, mentoring and managing remote teams
          </h4>
          <br />
    ...
    <section className="px-10 md:px-20 mt-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-6 my-10">
        ...
        <div className="flex flex-col col-span-4">
          <p>
            Working with a bespoke e-commerce platform (React, Perl, PHP and
            more)
          </p>
          <p>
            Managing diverse technical projects through process change,
            improvements and roll-outs.
          </p>
          <p>Integrating with third-party software applications.</p>
          <p>
            Collaborating with stakeholders, partners and project teams to meet
            project deadlines.
          </p>
          <p>
            Managing a small team of remoter engineers, coaching and mentoring,
            improving capabilities and competencies of technical teams.
          </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-6 my-10">
        ...
        <div className="flex flex-col col-span-4">
          <p>
            This is my limited company used for contracting work as well as
            other activities.{" "}
          </p>
          <p>
            Supporting small agencies with web development and server
            administration tasks.
          </p>
          <p>
            I've worked with Laravel and React frameworks such as GatsbyJS and
            NextJS.{" "}
          </p>
          <p>
            Tasks included developing new features, bug fixing and maintaining
            existing code.{" "}
          </p>
          <p>
          ...
          <p>
            Engaged with customers to better understand needs and deliver
            excellent service.{" "}
          </p>
          <p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-6 my-10">
        ...
        <div className="flex flex-col col-span-4">
          ...
          <p>
            Coaching and mentoring, improving capabilities and competencies of
            technical teams.
          </p>
          <p>
            Managed diverse technical projects through process change,
            improvements and roll-outs.
          </p>
          <p>
            Delivered clear, thorough IT services support to technical and
            non-technical staff for smooth company operations.
          </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-6 my-10">
        ...
        <div className="flex flex-col col-span-4">
          <p>
            Building and managing internal web applications used for managing
            various aspects of car finance business.
          </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-6 my-10">
        ...
        <div className="flex flex-col col-span-4">
          <p>
            Building backend (PHP) and frontend (Angular) web application used
            by many companies as intranet portal.
          </p>
          <p>
          ...
          <p>
            Implemented Google Cloud Platform scalable environment to met
            company and clients needs
          </p>
          <p>
            Stack: PHP, AngularJS, Grunt, Gulp, Vagrant, LAMP (Ubuntu, Centos),
            Google Cloud Platform, GIT, Jira
          </p>
        </div>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-6 my-10">
        ...
        <div className="flex flex-col col-span-4">
          <p>
            Working with bespoke e-commerce platform Implementing new features
          </p>
          <p>Fixing bugs</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-6 my-10">
        ...
        <div className="flex flex-col col-span-4">
          ...
          <p>
            Responsible for all aspects of developing and implementing
            Information Technology initiatives within the organization.
          </p>
          <p>
            Fixing security bugs, developing new functionalities, database
            designs, sys admin, frontend development.
          </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-6 my-10">
        ...
        <div className="flex flex-col col-span-4">
          <p>
            Creating bespoke web applications, maintaining existing websites,
            root servers administration, database management.
          </p>
          <p>
            Main project: kapiak.com (betting portal)- maintenance, creating new
            features, sys admin. Dealing with high traffic during highest
