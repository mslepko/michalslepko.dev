...
const UsesPage = () => (
  <Layout>
    <div className="container mx-auto p-8 pb-16 text-center max-w-screen-xl">
      ...
      <p className="text-darkest dark:text-lightest text-left pb-1 text-xl">
      ...
      <p className="text-darkest dark:text-lightest pb-1 text-xl text-left">
      ...
      <p className="text-darkest dark:text-lightest pb-1 text-xl mt-8">
        If you are interested or have questions please email me at{" "}
