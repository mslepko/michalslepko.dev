  ...
  return (
    <div className="box p-0">
      ...
      <div className="p-6 flex flex-col gap-y-1.5">
        <p className="font-bold text-darkest dark:text-lightest">{title}</p>
        <p className="text-dark dark:text-light">{description}</p>
        <div className="button-container items-center mt-3">
          {github && (
            <a href={github} className="github-icon">
              <svg
                className="w-6 h-6"
                role="img"
                viewBox="0 0 24 24"
          ...
          {url && (
            <a href={url} className="external-icon">
              <svg
